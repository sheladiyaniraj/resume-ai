  ...
  return (
    <div>
      <textarea
        ...
        rows={4}
        className="w-full text-sm border border-slate-200 rounded-lg px-3 py-2 text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-[#1A6FE8] focus:border-transparent transition-colors resize-none"
      />
